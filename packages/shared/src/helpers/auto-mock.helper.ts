 ...
 *
 * All methods are replaced with Jasmine spy functions (`jasmine.createSpy()`), and all properties are defined with a getter returning an empty string.
 *
...
export function autoMock<T>(obj: new (...args: any[]) => T): T {
  ...
  allMethods.forEach((method) => (res[method] = jasmine.createSpy(method)));
